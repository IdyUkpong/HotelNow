...
function AdminDashboard() {
  ...
  // Function to handle click event for Users
      ...
      <div className="flex-grow overflow-hidden h-full flex flex-col">
        <div className="h-16 lg:flex w-full border-b border-gray-200 dark:border-gray-800 hidden px-10">
          <div className="flex h-full text-gray-600 dark:text-gray-400">
            ...
            <a
              href="/ourhotels"
              className="cursor-pointer h-full border-b-2 border-transparent inline-flex items-center mr-8 hover:text-white"
            >
              Our Hotels
            </a>
          </div>
            ...
            <div className="space-y-4 mt-3">
              ...
              <button className="bg-white p-3 w-full flex flex-col rounded-md dark:bg-gray-800 shadow">
                ...
                <div className="flex items-center w-full">
                  ...
                  <div className="ml-auto text-xs text-gray-500">₦60,000</div>
                </div>
              </button>
              <button className="bg-white p-3 w-full flex flex-col rounded-md dark:bg-gray-800 shadow">
                <div className="flex xl:flex-row flex-col items-center font-medium text-gray-900 dark:text-white pb-2 mb-2 xl:border-b border-gray-200 border-opacity-75 dark:border-gray-700 w-full">
                  ...
                  Miss Solomon Theresa
                </div>
                <div className="flex items-center w-full">
                  <div className="text-xs py-1 px-2 leading-none dark:bg-gray-900 bg-blue-100 text-blue-500 rounded-md">
                    Total Amount
                  </div>
                  <div className="ml-auto text-xs text-gray-500">₦40,000</div>
                </div>
              </button>
              <button className="bg-white p-3 w-full flex flex-col rounded-md dark:bg-gray-800 shadow">
                <div className="flex xl:flex-row flex-col items-center font-medium text-gray-900 dark:text-white pb-2 mb-2 xl:border-b border-gray-200 border-opacity-75 dark:border-gray-700 w-full">
                ...
                <div className="flex items-center w-full">
                  ...
                  <div className="ml-auto text-xs text-gray-500">₦30,000</div>
                </div>
              </button>
            </div>
          </div>
